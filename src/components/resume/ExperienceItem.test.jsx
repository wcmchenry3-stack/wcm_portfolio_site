...
describe('ExperienceItem — single role', () => {
  ...
  it('renders role title as h4', () => {
    render(<ExperienceItem {...singleRoleJob} />)
    expect(screen.getByRole('heading', { level: 4, name: /senior product manager/i })).toBeInTheDocument()
  })
...
describe('ExperienceItem — multi-role', () => {
  ...
  it('renders all role titles', () => {
    render(<ExperienceItem {...multiRoleJob} />)
    expect(screen.getByRole('heading', { level: 4, name: /principal pm/i })).toBeInTheDocument()
    expect(screen.getByRole('heading', { level: 4, name: /senior pm/i })).toBeInTheDocument()
  })
